...
public class Core {
     ...
     * @param releaseServeHandle boolean indicating whether this is the last call for the file. In that case, the
     *                           server will release it's cached handle and update server metadata.
     *                           If you anticipate to write more bytes then pass false, otherwise pass true. If unsure,
     *                           pass true to be safe. This is a performance optimization.
    ...
    public static void create(String path,
                              ...
                              boolean releaseServeHandle,
                              ADLStoreClient client,
                              RequestOptions opts,
                              OperationResponse resp) {
        QueryParams qp = new QueryParams();
        qp.add("overwrite", Boolean.toString(overwrite));
        qp.add("flush", Boolean.toString(releaseServeHandle));
     ...
     * {@link #create(String, boolean, String, byte[], int, int, String, String, boolean, boolean, ADLStoreClient, RequestOptions, OperationResponse) create}.
     *
     *
     ...
     * @param leaseId a String containing the lease ID (generated by client). Can be null.
     * @param sessionId a String containing the session ID (generated by client). Can be null.
     * @param forceUpdateMetadata boolean indicating whether this is the last call for the file. In that case, the
     *                           server will release it's cached handle and update server metadata.
     *                           If you anticipate to write more bytes then pass false, otherwise pass true. If unsure,
     *                           pass true to be safe. This is a performance optimization.*
     * @param client the {@link ADLStoreClient}
