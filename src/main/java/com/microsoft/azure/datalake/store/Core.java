...
public class Core {
    ...
    public static List<DirectoryEntry> listStatus(String path,
        ...
        DirectoryEntryListWithContinuationToken val = listStatusWithToken(path, listAfter, listBefore, listSize, oidOrUpn, client, opts, resp);
        return val.getEntries();
    }

    /**
     * enumerates the contents of a direcotroy, returning a {@link DirectoryEntryListWithContinuationToken} object,
     * containing continuationToken and a {@link List} of {@link DirectoryEntry} objects
     * one per file or directory in the specified directory.
     * <P>
     * To avoid overwhelming the client or the server, the call may return a partial list, in which case
     * the caller should make the call again with the last entry from the returned list specified as the
     ...
     * @return {@link List}&lt;{@link DirectoryEntry}&gt; containing the contents of the directory
     */
     static DirectoryEntryListWithContinuationToken listStatusWithToken(String path,
                                                  String listAfter,
                                                  String listBefore,
                                                  int listSize,
                                                  UserGroupRepresentation oidOrUpn,
