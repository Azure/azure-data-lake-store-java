...
public class Core {
     ...
     *                 retrieved from
     *                 {@link #getFileStatus(String, ADLStoreClient, HttpClientConnectionManager, RequestOptions, OperationResponse)}
     *                 or {@link #listStatus(String, String, String, int, ADLStoreClient, HttpClientConnectionManager, RequestOptions, OperationResponse)} API call.
    ...
    public static void create(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.CREATE, path, qp, contents, offsetWithinContentsArray, length, opts, resp);
    }

    /**
     * append bytes to an existing file created with
     *
     * {@link #create(String, boolean, String, byte[], int, int, String, String, boolean, SyncFlag, ADLStoreClient, HttpClientConnectionManager, RequestOptions, OperationResponse)} (String, boolean, String, byte[], int, int, String, String, boolean, boolean, ADLStoreClient, HttpClientConnectionManager, RequestOptions, OperationResponse) create}.
     *
    ...
    public static void append(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.APPEND, path, qp, contents, offsetWithinContentsArray, length, opts, resp);
    }
    ...
    public static void concurrentAppend(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.CONCURRENTAPPEND, path, qp, contents, offsetWithinContentsArray, length, opts, resp);
    }
    ...
    public static InputStream open(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.OPEN, path, qp, null, 0, 0, opts, resp);
    ...
    public static boolean delete(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.DELETE, path, qp, null, 0, 0, opts, resp);
    ...
    public static boolean rename(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.RENAME, path, qp, null, 0, 0, opts, resp);
        if (!resp.successful) return false;
    ...
    public static boolean mkdirs(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.MKDIRS, path, qp, null, 0, 0, opts, resp);
        if (!resp.successful) return false;
    ...
    public static void setExpiryTime(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.SETEXPIRY, path, qp, null, 0, 0, opts, resp);
    }
    ...
    public static ContentSummary getContentSummary(String path,
                                 ...
                                 RequestOptions opts,
                                 OperationResponse resp) {
        HttpTransport.makeCall(client, connectionManager, Operation.GETCONTENTSUMMARY, path, null, null, 0, 0, opts, resp);
    ...
    public static void concat(String path,
                              ...
                              RequestOptions opts,
                              OperationResponse resp) {
        concat(path, sources, client, connectionManager, false, opts, resp);
    }
    ...
    public static void concat(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.MSCONCAT, path, qp, body, 0, body.length, opts, resp);
    }
    ...
    public static DirectoryEntry getFileStatus(String path,
        ...
        return getFileStatus(path, null, client, connectionManager, opts, resp);
    }
    ...
    public static DirectoryEntry getFileStatus(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.GETFILESTATUS, path, qp, null, 0, 0, opts, resp);
    ...
    public static List<DirectoryEntry> listStatus(String path,
                                                  ...
                                                  RequestOptions opts,
                                                  OperationResponse resp) {
        return listStatus(path, listAfter, listBefore, listSize, null, client, connectionManager, opts, resp);
    }
    ...
    public static List<DirectoryEntry> listStatus(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.LISTSTATUS, path, qp, null, 0, 0, opts, resp);
    ...
    public static void setTimes(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.SETTIMES, path, qp, null, 0, 0, opts, resp);
    }
    ...
    public static void setOwner(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.SETOWNER, path, qp, null, 0, 0, opts, resp);
    }
     ...
     * {@link #setAcl(String, List, ADLStoreClient, HttpClientConnectionManager, RequestOptions, OperationResponse) setAcl} call.
     *
     *
    ...
    public static void setPermission(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.SETPERMISSION, path, qp, null, 0, 0, opts, resp);
    }
    ...
    public static void checkAccess(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.CHECKACCESS, path, qp, null, 0, 0, opts, resp);
    }
    ...
    public static void modifyAclEntries(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.MODIFYACLENTRIES, path, qp, null, 0, 0, opts, resp);
    }
    ...
    public static void removeAclEntries(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.REMOVEACLENTRIES, path, qp, null, 0, 0, opts, resp);
    }
    ...
    public static void removeDefaultAcl(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.REMOVEDEFAULTACL, path, null, null, 0, 0, opts, resp);
    }
    ...
    public static void removeAcl(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.REMOVEACL, path, null, null, 0, 0, opts, resp);
    }
    ...
    public static void setAcl(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.SETACL, path, qp, null, 0, 0, opts, resp);
    }
    ...
    public static void setAcl(String path,
        ...
        setAcl(path, AclEntry.aclListToString(aclSpec), client, connectionManager, opts, resp);
    }
    ...
    public static AclStatus getAclStatus(String path,
                                         ...
                                         RequestOptions opts,
                                         OperationResponse resp) {
        return getAclStatus(path, null, client, connectionManager, opts, resp);
    }
    ...
    public static AclStatus getAclStatus(String path,
        ...
        HttpTransport.makeCall(client, connectionManager, Operation.GETACLSTATUS, path, qp, null, 0, 0, opts, resp);
